 ...
 */
final class AccessDeniedException extends DomainException implements ProblemDetailsException
{
    use ProvidesCommonProblemDetailsException;

    public static function generate(string $message): self
    {
        $self = new self($message, StatusCodeInterface::STATUS_UNAUTHORIZED);
